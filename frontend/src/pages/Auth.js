...
const Auth = () => {
    ...
    const phoneBlur = () => {
        ...
        if (userFormData.phone === ``) {
            setValidationMessage({ ...validationMessage, phone: 'Phone number is required' });
        } 
        else if (!phoneRegex.test(userFormData.phone)) {
            setValidationMessage({ ...validationMessage, phone: 'Please enter a valid phone number (10-15 digits)' });
        } 
        else {
